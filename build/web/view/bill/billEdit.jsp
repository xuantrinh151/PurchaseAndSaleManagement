                ...
                <jsp:include page="../common/left.jsp"></jsp:include>
                    <div class="right">
                        ...
                        <form class="form-horizontal" style="    margin-top: 160px;
                              margin-left: 70px;" action="bill-edit" method="POST" >
                            <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="stock_alert" name="bill_id" value="${b.getbId()}" class="form-control input-md" required="" type="hidden">
                                </div>
                            </div>
                                ...
                                <div class="col-md-2" >
                                    ...
                                    <select style="width: 174px;" class="form-select" size="4" aria-label="size 4 select example" name="customer">
                                        ...
                                        <c:forEach items="${customers}" var="c">
                                            <option 
                                                <c:if test="${b.getCustomer().getcId() == c.getcId()}"> selected</c:if>
                                ...
                                <div class="col-md-2" >
                                    ...
                                    <select style="width: 174px;" class="form-select" size="4" aria-label="size 4 select example" name="user">
                                        ...
                                        <c:forEach items="${users}" var="u">
                                            <option 
                                                <c:if test="${b.getUser().getuId() == u.getuId()}"> selected</c:if>
                                                value="${u.getuId()}">${u.getuName()}</option>
                                        </c:forEach>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="stock_alert" name="time" value="${b.getTime()}" class="form-control input-md" required="" type="date">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button id="singlebutton" name="singlebutton" class="btn btn-primary">EditBill</button>
                                </div>
                            </div>
